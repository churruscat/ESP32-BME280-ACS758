...
#define NUMERO_DE_ENVIOS 3000 // cada cuanto tiempo envio datos de temp, humedad y predion
...
int sensorSolar,sensorBat ;

// otras variables
int tocatemp=NUMERO_DE_ENVIOS+1;
int intervaloConex;
